        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FreeTextDesc = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ImageUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tickets_users_ConfirmedById",
            ...
            migrationBuilder.CreateTable(
                name: "deadline_histories",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TicketId = table.Column<Guid>(type: "uuid", nullable: false),
                    OldDeadline = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_deadline_histories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_deadline_histories_tickets_TicketId",
                        column: x => x.TicketId,
                        principalTable: "tickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_deadline_histories_users_ChangedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_deadline_histories_ChangedById",
                table: "deadline_histories",
                column: "ChangedById");

            migrationBuilder.CreateIndex(
                name: "IX_deadline_histories_TicketId",
                table: "deadline_histories",
                column: "TicketId");
